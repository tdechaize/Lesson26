# Lesson26
Lesson26 OpenGL (from NeHe)

Vous trouverez dans le sommaire ci-dessous les explications vous permettant de regénérer cette application illustrant deux cas d'usages d'OpenGL :
Stencel & Reflection (issu du site NeHe).
...
Project Description : Stencel & Reflection Tutorial

Authors Name: Jeff Molofee (aka NeHe) & Banu Octavian
